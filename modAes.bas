...
'Codigo fuente: https://www.vbforums.com/showthread.php?862103-VB6-Simple-AES-256-bit-password-protected-encryption
'--- mdAesCtr.bas
Option Explicit
DefObj A-Z
...
Public Function AesEncryptString() As String
    Dim baData()        As Byte
    Dim sError          As String
    
    baData = ToUtf8Array(Texto)
    If Not AesCryptArray(baData, ToUtf8Array(Clave), Error:=sError) Then
        Err.Raise vbObjectError, , sError
    End If
    AesEncryptString = ToBase64Array(baData)
End Function
 
Public Function AesDecryptString(sEncr As String) As String
    Dim baData()        As Byte
    Dim sError          As String
